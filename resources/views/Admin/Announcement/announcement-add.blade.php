...
<div class="row justify-content-center">
    <div class="col-12 col-lg-10 col-xl-10 mx-auto ">
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="h3  page-title ">{{ trans('app.announcement.add-new-announcements')}}</div>
            </div>
            <div class="col-sm-3 ">
                <div style="margin-top: 5px;">
                    <label for="">{{ trans('app.announcement.preview')}} </label>
                    <input type="checkbox" onchange="showPreview()" class="checkbox" checked  id="announcement-preview" data-bootstrap-switch="">
                </div>
            </div>
        </div>
        ...
        <div class="my-4">
            ...
            <form role="form" id="announcement-form" onsubmit="return submitAnnouncement();" action="{{ route('admin.announcement.create') }}" method="POST">
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col">
                        ...
                        <div class="input-group">
                            ...
                            <input name="announcementDatetimeRange" value="{{ old('announcementDatetimeRange') ? old('announcementDatetimeRange') : '' }}" type="text" class="form-control float-right" required id="announcement-datetime-range">
                            <input type="text" id="announcementStartDate" value="{{ old('announcementStartDate') ? old('announcementStartDate') : '' }}" name="announcementStartDate" style="display: none;">
                            <input type="text" id="announcementEndDate" value="{{ old('announcementEndDate') ? old('announcementEndDate') : '' }}" name="announcementEndDate" style="display: none;">
                        </div>
                        <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                    ...
                    <div class="form-group col">
                        ...
                        <select required name="audience" id="audience" class="form-control">
                            ...
                            <option value="{{$audi->_id}}">{{ $audi->name }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col ">
                        ...
                        <textarea required rows="2" name="description" id="description" placeholder=""  class="form-control">{{ old("description") ? old("description") : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col">
                        ...
                        <div class="input-group my-colorpicker2 colorpicker-element" data-colorpicker-id="2">
                            <input type="text" id="color-picker" name="announcement-background-color" value="rgba(29, 192, 243, 0.54)" class="form-control" data-original-title="" title="">
                            <div class="input-group-append">
                                <span class="input-group-text">
                                    <i id="" class="fas fa-square" style="color: rgba(29, 192, 243, 0.54);"></i>
                                </span>
                            </div>
                        </div>
                        <!-- /.input group -->
                    ...
                    <div class="form-group margin col">
                        ...
                        <input id="range" name="border-radius" type="text" value="">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col" style="margin-bottom: 0rem;">
                        <div class="custom-control custom-checkbox" style="padding-left: 0rem;">
                            <input name="closeable" class="inp-cbx" type="checkbox" style="display: none;" id="can-closed" />
                ...
                <div class="form-row">
                    <div class="form-group col ">
                        <label for="announcement">{{ trans('app.announcement.text')}}</label>
                        <textarea rows="5" name="announcement-text" id="announcement" placeholder="" class="form-control">{{ old("announcement") ? old("announcement") : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="card card-default collapsed-card">
                    <div class="card-header" style="justify-content: center;">
                        ...
                        <div class="card-tools">
                            ...
                            <input type="checkbox" onchange="checkTimer()" class="checkbox" name="hasTimer" id="timer" data-bootstrap-switch="">
                    ...
                    <div class="card-body" style="display: none;">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group my-colorpicker1 colorpicker-element" data-colorpicker-id="2">
                                        <input type="text" id="timer-background-color-picker" name="timer-background-color" value="{{ old('timer-background-color') ? old('timer-background-color') : 'rgb(221, 86, 86)' }}" class="form-control" data-original-title="" title="">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group my-colorpicker3 colorpicker-element" data-colorpicker-id="2">
                                        <input type="text" id="timer-font-color-picker" name="timer-font-color" value="{{ old('timer-font-color') ? old('timer-font-color') : 'rgb(255, 255, 255)' }}" class="form-control" data-original-title="" title="">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i id="" class="fas fa-square" style="color: rgb(255, 255, 255);"></i>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <!-- /.form-group -->
                                <div class="form-group">
                                    <label>T{{ trans('app.announcement.timer.elements')}}</label>

                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="custom-control" style="padding-left: 0rem;">
                                                <input class="inp-cbx" type="checkbox" style="display: none;" id="with-seconds" name="with-seconds" checked />
                                        ...
                                        <div class="col-sm-6">
                                            <div class="custom-control" style="padding-left: 0rem;">
                                                <input class="inp-cbx" type="checkbox" style="display: none;" id="with-minutes" name="with-minutes" checked />
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="custom-control" style="padding-left: 0rem;">
                                                <input class="inp-cbx" type="checkbox" style="display: none;" id="with-hours" name="with-hours" checked />
                                        ...
                                        <div class="col-sm-6">
                                            <div class="custom-control" style="padding-left: 0rem;">
                                                <input class="inp-cbx" type="checkbox" style="display: none;" id="with-days" name="with-days" checked />
...
<script>
    $(function() {
        ...
        $('#announcement-datetime-range').val(null);
        '';
...
<script>
    ...
    var announcementStartDate = new Date().getTime();
    var announcementEndDate = new Date().getTime();
