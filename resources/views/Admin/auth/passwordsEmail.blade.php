...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="{{ url('/design/adminLTE') }}/index2.html"><b>Admin</b>Definition</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Define new admin</p>
            @include('admin.message.error')
            @include('admin.message.success')
            @include('admin.message.info')
            @include('admin.message.warning')
            <form action=" {{ url('admin/define') }} " method="post">
                @csrf
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <button type="submit" class="btn btn-primary btn-block btn-flat">Invite</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
