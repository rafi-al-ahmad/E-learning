...
<div class="row justify-content-center">
    <div class="col-12 col-lg-10 col-xl-8 mx-auto">
        <h2 class="h3 mb-4 page-title">{{ trans('app.title.add-new-language')}}</h2>
        <hr>
        <div class="my-4">

            <form  role="form" action="{{ route('admin.defineLanguage') }}" method="POST">
                @csrf
                ...
                <div class="form-row">
                    <div class="form-group col-md-5">
                        ...
                        <input required name="name" type="text"  class="form-control" id="Name" placeholder="English" />
                    </div>
                    <div class="form-group col-md-3">
                        <label for="Code">{{ trans('app.language.code')}}</label>
                        <input required name="code" type="text" class="form-control" id="Code" placeholder="en" />
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col ">
                        ...
                        <textarea rows="2" name="description" id="description" placeholder="" class="form-control"></textarea>
                    </div>
                </div>


                @foreach($englishlang->payload as $key => $value)
                <div id="{{$key}}">
                    <!-- <hr class="mb-8"> -->
                    ...
                    <hr>
                    @if(is_array($value))
                    {{ ( langArrayPrintInputs($value,$key))}}
                    @endif
