...
<div class="container-fluid" data-select2-id="32">
    <form role="form" action="{{ route('admin.audience.create') }}" method="post">
        @csrf
        <!-- SELECT2 EXAMPLE -->
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" id="name" required name="name" value="{{ old('name') ? old('name') : '' }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" id="tdescription" required name="description" value="{{ old('description') ? old('description') : '' }}" class="form-control">
        ...
        <div class="card card-default " data-select2-id="31">
            <div class="card-header">
                ...
                <button id="geo-btn" type="button" class="btn btn-tool" data-card-widget="collapse">
                    ...
                    <input type="checkbox" onchange="checkGeo()" class="checkbox" name="rules[]" value="geo" id="geo-check" data-bootstrap-switch="">
                ...
                <div class="form-group" data-select2-id="29">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select name="geo-country" id="geo-countries" class="form-control bfh-countries" data-country=""></select>
                        </div>
                        <!-- /.col -->
                        <div class="col-md-6">
                            <label>{{ trans('app.audience.geo-rule.state')}}</label>
                            <select name="geo-state" id="geo-states" class="form-control bfh-states" data-country="geo-countries"></select>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
        ...
        <div class="card card-default ">
            <div class="card-header" style="justify-content: center;">
                ...
                <div class="card-tools">
                    ...
                    <input type="checkbox" onchange="checkTimezone() " class="checkbox" name="rules[]" value="timezone" id="timezone-check" data-bootstrap-switch="">
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="form-group" data-select2-id="29">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select name="timezone-country" id="timezone-countries" class="form-control bfh-countries" data-country="{{ isset($settings->time) ? $settings->getAttribute('time.country') :'' }}"></select>

                        </div>
                        <!-- /.col -->
                        <div class="col-md-6">
                            <label>{{ trans('app.audience.timezone-rule.state')}}</label>
                            <select name="timezone-state" id="timezone-state" class="form-control bfh-timezones" data-country="timezone-countries"></select>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
